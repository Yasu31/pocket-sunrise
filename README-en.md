...
- Solder only 4 of the 300Ω resistors for the 7-segment display, and short-circuit the rest, as you can see in the images. (this design allows you to change the orientation of the 7-segment display later).
...
- I recommend you attach the heatsink to the other side of the LED as well as the resistors.
